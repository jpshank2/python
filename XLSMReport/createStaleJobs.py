...
def create(name):
    ...
    xl.Visible = 1
    xl.DisplayAlerts = 0
    wb = xl.Workbooks.Open("C:\\Users\\jeremyshank\\Documents\\BMSS Assets\\Reports\\StaleJobsReport.xlsm")
    writeData = wb.Worksheets('Staff')
    writeData.Cells(1,1).Value = name[0]
    xl.Application.Run("DueDateQuery")
    wb.SaveAs("C:\\Users\\jeremyshank\\BMSS\\Business Intelligence - Documents\\Ad Hoc Reports\\Reports for PA\\Stale\\" + name[1] + " Stale Jobs Report.xlsx", FileFormat=51)

...
ORDER BY e.ClientCode""")
    ...
    if len(noLetter) > 0 or len(noADValorem) > 0:
        ...
        mail.To = 'jeremyshank@bmss.com'  # record[1]
        mail.Subject = 'Please Read - Important Ad Valorem Info'
        mail.HTMLBody = '<p>Hi ' + myFirstLast[0] + ',</p><p>I just wanted to follow up again regarding clients of yours that have not provided us with a signed engagement letter and/or have not completed worksheets for the 2021 Business Personal Property Tax year:</p><u><strong>No Signed Engagement Letter:</strong></u><ul>' + \
